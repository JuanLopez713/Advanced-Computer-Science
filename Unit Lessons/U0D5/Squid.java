public class Squid {
    ...
    // a built in method that returns all of the values of an object in a nice
    // sentence.
    public String toString() {
        return "This is a squid. It has " + tentacleCount + " tentacles, and it's current ink level is " + inkMeter
